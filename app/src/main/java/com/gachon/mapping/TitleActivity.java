...
public class TitleActivity extends AppCompatActivity {
    ...
    public void InitializeView()
    {
        ...
        idbutton = (Button) findViewById(R.id.ID);
    ...
    public void IdListener()
    {
        idbutton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Intent mapintent = new Intent(getApplicationContext(), idActivity.class);
                startActivityForResult(mapintent,101); }
    ...
    public void ImageListener()
    {
        imagebutton.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Intent imageintent = new Intent(getApplicationContext(), DirayActivity.class);
